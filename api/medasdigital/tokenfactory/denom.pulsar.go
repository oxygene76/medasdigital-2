...
func init() {
	...
	md_Denom = File_medasdigital_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_medasdigital_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "medasdigital.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "medasdigital.tokenfactory.Denom.description":
		return x.Description != ""
	case "medasdigital.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "medasdigital.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "medasdigital.tokenfactory.Denom.url":
		return x.Url != ""
	case "medasdigital.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "medasdigital.tokenfactory.Denom.supply":
		return x.Supply != int32(0)
	case "medasdigital.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "medasdigital.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: medasdigital.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message medasdigital.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message medasdigital.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "medasdigital.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message medasdigital.tokenfactory.Denom is not mutable"))
	case "medasdigital.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message medasdigital.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: medasdigital.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in medasdigital.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: medasdigital/tokenfactory/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_medasdigital_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_medasdigital_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_medasdigital_tokenfactory_denom_proto_rawDesc = []byte{
	...
	0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x6d, 0x65, 0x64, 0x61, 0x73, 0x64, 0x69,
	0x67, 0x69, 0x74, 0x61, 0x6c, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f,
	0x72, 0x79, 0x22, 0x83, 0x02, 0x0a, 0x05, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x14, 0x0a, 0x05,
	0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x64, 0x65, 0x6e,
	0x6f, 0x6d, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x18, 0x03,
	...
	,
}

var (
	file_medasdigital_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_medasdigital_tokenfactory_denom_proto_rawDescData = file_medasdigital_tokenfactory_denom_proto_rawDesc
)

func file_medasdigital_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_medasdigital_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_medasdigital_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_medasdigital_tokenfactory_denom_proto_rawDescData)
	})
	return file_medasdigital_tokenfactory_denom_proto_rawDescData
}

var file_medasdigital_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_medasdigital_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: medasdigital.tokenfactory.Denom
}
var file_medasdigital_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_medasdigital_tokenfactory_denom_proto_init() }
func file_medasdigital_tokenfactory_denom_proto_init() {
	if File_medasdigital_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_medasdigital_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_medasdigital_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_medasdigital_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_medasdigital_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_medasdigital_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_medasdigital_tokenfactory_denom_proto = out.File
	file_medasdigital_tokenfactory_denom_proto_rawDesc = nil
	file_medasdigital_tokenfactory_denom_proto_goTypes = nil
	file_medasdigital_tokenfactory_denom_proto_depIdxs = nil
}
